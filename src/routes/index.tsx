...
// Set to true to re-enable the horizontal snap-scrolling slide deck for demos.
const USE_HORIZONTAL_SLIDES = false;
...
// NOTE: Original horizontal snap-scrolling slide deck is preserved below.
// To re-enable it for Alpha demos or future releases, set USE_HORIZONTAL_SLIDES = true
// and replace the <VerticalLanding /> call with <HorizontalSlides />.
