...
const groups: Group[] = [
  ...
  },
  {
    label: "Measure",
    items: [
      { to: "/app/models", label: "Multi-model", icon: Layers, phase: 2, tooltip: "Compare how different AI models (GPT, Claude, Gemini) cite Voya across the same prompts." },
    ...
    <div className="min-h-screen flex w-full bg-secondary/30">
      ...
      <aside className="hidden md:flex w-64 shrink-0 flex-col border-r border-border bg-card">
        <Link to="/" className="flex items-center gap-2 px-5 h-16 border-b border-border">
          ...
          <span className="text-xs font-semibold tracking-wide text-foreground/80">Activation Studio</span>
        </Link>
